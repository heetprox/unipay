    ...
    <div className="min-h-screen bg-black text-white p-4">
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-6 p-4 bg-white/5 rounded-lg border border-gray-800">
          ...
          >
            {paymentStatus === "pending" &&
              "Monitoring payment automatically..."}
          ...
          {paymentStatus === "pending" && (
            <div className="text-xs text-gray-400">
              ...
              <p className="mt-1">
                Complete your payment in the UPI app and we'll detect it
                automatically
              </p>
            </div>
          )}
          ...
          {paymentStatus === "failed" && (
            <div className="text-xs text-red-300">
              <p>
                ❌ Payment was not successful. You can try again or contact
                support.
              </p>
            </div>
          )}
        ...
        <div className="mt-6 p-4 bg-blue-900/20 border border-blue-700 rounded-lg">
          ...
          <ol className="text-sm text-blue-200 space-y-1 list-decimal list-inside">
            ...
            <li>
              <strong>Sit back and relax!</strong> We're monitoring your payment
              automatically
            </li>
            <li>
              Once confirmed, your tokens will be automatically minted to your
              wallet!
            </li>
          </ol>

          <div className="mt-3 p-2 bg-blue-800/30 rounded text-xs text-blue-100">
            💡 <strong>No need to refresh!</strong> This page automatically
            checks your payment status every 2 seconds.
          </div>
        </div>
